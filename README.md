...
```bash
POSTGRES_HOST="" POSTGRES_PORT="" POSTGRES_USER="" POSTGRES_PASSWORD="" POSTGRES_DATABASE="" PRICE_UPDATER_URL="" ./update-price
```
...
```bash
./update-price -POSTGRES_HOST="" -POSTGRES_PORT="" -POSTGRES_USER="" -POSTGRES_PASSWORD="" -POSTGRES_DATABASE="" -PRICE_UPDATER_URL="" 
```
